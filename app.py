...
def create_pdf_report(patient_name, patient_id, diagnosis, confidence, original_path, blended_path):
    ...
    pdf.multi_cell(0, 10, "Disclaimer: This report is generated by an automated AI system to assist clinical interpretation. Please correlate these findings with other clinical data.", align='C')
...
def download_models():
    ...
    resnet_path = "models/resnet_finetuned.h5"
    effnet_path = "models/effnet_finetuned.h5"

    if not os.path.exists(resnet_path):
        resnet_id = "17OBd32DouUuhE0de1SYSwMZB8wf8C8gu"
        gdown.download(id=resnet_id, output=resnet_path, quiet=False)

    if not os.path.exists(effnet_path):
        effnet_id = "1gMT5miJ4lm7Bl2JfCeKUhmgXlMAHJ4r1"
...
def load_models():
    resnet = load_model("models/resnet_finetuned.h5", compile=False)
    effnet = load_model("models/effnet_finetuned.h5", compile=False)
